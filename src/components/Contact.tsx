      ...
      <div className='h-screen flex justify-around '>
        ...
        >
          ...
          <motion.p
            ...
            variants={FADE_UP_ANIMATION_VARIANTS}
          >
            Looking for AAA+ services provider to upscale your business by
            creating Lightning Fast Scalable dynamic web Application? Get Free
            Consultation Now
          </motion.p>
          ...
          >
            ...
            className="text-lg text-foreground-500"
              href='mailto:tajkhan.dev@gmail.com'
              variants={FADE_UP_ANIMATION_VARIANTS}
            >
       ...
       <Link href="https://www.linkedin.com/in/web3-metaverse-ai-jamstack-expert/ " target="_blank">
       ...
       <Link href="https://github.com/tajkhan-dev">
        <svg
         xmlns='http://www.w3.org/2000/svg'
         width='36'
         height='36'
...
<Link href="https://www.instagram.com/tajkhan_dev/" target="_blank">
